...
> Mirror of [.claude/skills/microservice-pattern/SKILL.md](../.claude/skills/microservice-pattern/SKILL.md) so non-Claude agents (Codex, Cursor, Copilot, etc.) load the same rules. Keep both files in sync — when one changes, update the other.
